...
namespace NullSoftware.ToolKit.Converters
{
    ...
    public class InverseBooleanToHiddenVisibilityConverter : IValueConverter, IMultiValueConverter
    {
        ...
        /// <returns>
        /// <see cref="Visibility.Hidden"/> if value is true;
        ...
        /// <param name="culture">This parameter is not used.</param>
        /// <returns>
        /// <see cref="Visibility.Hidden"/> if all values is true;
        /// otherwise, <see cref="Visibility.Visible"/>.
        /// </returns>
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            return values.All(t => (bool?)t == true) ? Visibility.Hidden : Visibility.Visible;
        }
