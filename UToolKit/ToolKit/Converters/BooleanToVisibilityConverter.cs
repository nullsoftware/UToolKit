...
namespace NullSoftware.ToolKit.Converters
{
    ...
    public class BooleanToVisibilityConverter : IValueConverter, IMultiValueConverter
    {
        ...
        /// <returns>
        /// <see cref="Visibility.Visible"/> if value is true;
        ...
        /// <param name="culture">This parameter is not used.</param>
        /// <returns>
        /// true if value is <see cref="Visibility.Visible"/>; otherwise, false.
        /// </returns>
        ...
        /// <param name="culture">This parameter is not used.</param>
        /// <returns>
        /// <see cref="Visibility.Visible"/> if all values is true;
        /// otherwise, <see cref="Visibility.Collapsed"/>.
        /// </returns>
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            return values.All(t => (bool?)t == true) ? Visibility.Visible : Visibility.Collapsed;
        }
        ...
        /// <param name="culture">This parameter is not used.</param>
        /// <returns>
        /// bool array with positive values if value is <see cref="Visibility.Visible"/>;
